...
void ScrollBar::Create(HWND hWnd, const int x, const int y, const int height, const bool horz)
{
	hCtrl = CreateWindow("SCROLLBAR", NULL, WS_CHILD | WS_VISIBLE | (horz ? SBS_HORZ : SBS_VERT), x, y, (horz ? height : 15), (horz ? 15 : height), hWnd, NULL, NULL, NULL);
	if (hCtrl == NULL)
